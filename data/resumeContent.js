...
export const personal = {
  ...
  heroHeadline:
    "I am a Grit:Lab student focused on full-stack development and DevOps.",
  heroStatement:
    "I build modern, reliable web applications and the systems that support them.",
  aboutHeading:
    "I build practical digital products with full-stack and DevOps skills.",
  aboutParagraphs: [
...
export const projects = [
  ...
  },
  {
    ...
    impact:
      "Featured in multiple design galleries and attracted enterprise clients.",
    cta: "Open Prototype",
  },
  {
    id: "03",
    title: "Neon Biome",
    concept:
      "An AI-assisted storytelling platform for product education at scale.",
...
export const openSourceFallback = [
  {
    ...
    description:
      "Reusable GSAP scene transitions for narrative web experiences.",
    language: "JavaScript",
    stars: 124,
  ...
  },
  {
    ...
    description:
      "Composable Tailwind blocks tuned for visual storytelling layouts.",
    language: "TypeScript",
    stars: 88,
  ...
  },
  {
    ...
    description:
      "Automation toolkit for Lighthouse budgets and regression tracking.",
    language: "JavaScript",
    stars: 73,
...
export const achievements = [
  {
    ...
    issuer: "Awwwards",
    detail:
      "Recognized for immersive interaction design and execution quality.",
  },
  {
    year: "2024",
  ...
  },
  {
    ...
    detail:
      "Launch microsite shortlisted for interaction clarity and conversion lift.",
  },
  {
    year: "2022",
    ...
    issuer: "Meta",
    detail:
      "Formal certification in frontend architecture and testing workflows.",
  },
];
...
export const philosophy = {
  quote:
    "The best interfaces do more than inform. They make people feel momentum.",
...
export const contact = {
  ...
  statement:
    "Available for junior full-stack development and DevOps opportunities. I can also dive into tech support or back office roles where I can contribute to system reliability and customer satisfaction.",
  methods: [
    {
      label: "Email",
      value: "geraldineaddams9@gmail.com",
      href: "mailto:geraldineaddams9@gmail.com",
    },
    {
      label: "LinkedIn",
      value: "linkedin.com/in/geraldine-addamo",
      href: "https://www.linkedin.com/in/geraldine-addamo-3449a91b9",
    },
    {
      label: "GitHub",
      value: "github.com/giAddams",
      href: "https://github.com/giAddams",
    },
  ],
};
